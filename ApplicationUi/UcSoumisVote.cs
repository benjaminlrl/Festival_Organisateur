...
{
    public partial class UcSoumisVote : UserControl
    {
        ...
        public UcSoumisVote(Organisateur unOrganisateurConnecte)
        {
            InitializeComponent();
            ...
            if (_serviceOrganisateur.EstAutoriser(_organisateurConnecte, Organisateur.LesUC.UcSoumisVote, "Ajouter") == false)
            {
                buttonAjouter.Visible = false;
                DesactiverInputs();

            }
            if (_serviceOrganisateur.EstAutoriser(_organisateurConnecte, Organisateur.LesUC.UcSoumisVote, "Modifier") == false)
            {
                buttonModifier.Visible = false;
                DesactiverInputs();
            }
            if (_serviceOrganisateur.EstAutoriser(_organisateurConnecte, Organisateur.LesUC.UcSoumisVote, "Supprimer") == false)
            {
